...
**Claude Code: Project-scoped plugin support**

Superpowers now supports Claude Code's project-scoped plugin installs, allowing you to install the plugin for a specific project instead of globally. Run `/plugin install superpowers@superpowers-marketplace` within a specific project to create a project-local installation in `.claude-plugin/`. The SessionStart hook automatically detects both global and project-scoped installations via the `CLAUDE_PLUGIN_ROOT` environment variable.
...
The headline change is **skills repository separation**: all skills, scripts, and documentation have moved from the plugin into a dedicated repository ([fiascosauce/superpowers-skills](https://github.com/fiascosauce/superpowers-skills)). This transforms superpowers from a monolithic plugin into a lightweight shim that manages a local clone of the skills repository. Skills auto-update on session start. Users fork and contribute improvements via standard git workflows. The skills library versions independently from the plugin.
...
**The biggest change:** Skills no longer live in the plugin. They've been moved to a separate repository at [fiascosauce/superpowers-skills](https://github.com/fiascosauce/superpowers-skills).
...
3. Fresh clone of fiascosauce/superpowers-skills will be created at `~/.config/superpowers/skills/`
...
- Clones fiascosauce/superpowers-skills on first run
...
**Removed:**
- `skills/` directory (82 files) - Now in fiascosauce/superpowers-skills
- `scripts/` directory - Now in fiascosauce/superpowers-skills/skills/using-skills/
...
- Skills repository is now at https://github.com/fiascosauce/superpowers-skills
...
**Full Changelog:** https://github.com/fiascosauce/superpowers/compare/dd013f6...main
**Skills Repository:** https://github.com/fiascosauce/superpowers-skills
